...
const AboutMe = () => {
    return (
        <section id="about" className="container mx-auto py-16 lg:py-20">
            <div className="w-11/12 md:w-10/12 lg:w-8/12 mx-auto">
                <h2 className="text-[42px] font-extrabold text-primary text-center mb-8">
                    About Me
                </h2>
                ...
                <div className="mt-10 space-y-8">
                    ...
                    <div className="bg-gray-800 shadow-lg rounded-2xl p-6">
                        <h3 className="text-2xl font-semibold text-primary mb-3">💡 Why I Love Programming</h3>
                        <p className="text-gray-300">
                            ...
                            times, but always rewarding. I love creating <strong>sleek e-commerce sites, engaging portfolios, and full-fledged applications</strong>
                            that make life easier for people.
                        </p>
                    </div>

                    <div className="bg-gray-800 shadow-lg rounded-2xl p-6">
                        <h3 className="text-2xl font-semibold text-primary mb-3">🌟 What’s Next?</h3>
                        <p className="text-gray-300">
                            ...
                            for ways to grow. My goal is to build innovative web solutions that <strong>enhance user experiences</strong>
