                ...
                <div className="w-11/12 lg:w-10/12 mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-gray-900 p-6 rounded-lg shadow-lg">
                            ...
                            <button className="bg-primary text-secondary hover:bg-transparent hover:text-primary border border-primary font-poppins px-6 py-2 rounded-md font-semibold transition">
                                Send
                            </button>
                        </div>
